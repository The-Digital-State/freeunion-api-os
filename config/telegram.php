...
use App\Console\Commands\Telegram\PostVerifyCommand;
...
return [
    ...
    */
    'bots' => [
        'post_bot' => [
            'username' => 'FreeUnion Post',
            'token' => env('TELEGRAM_POST_BOT'),
            'certificate_path' => env('TELEGRAM_CERTIFICATE_PATH'),
            'webhook_url' => config('app.url').'/whJ9CehFz35DJhkDgn9J97R3JZcKJysBfYJ28NHQxfgZei3V/webhook',
            'commands' => [
                PostVerifyCommand::class,
            ],
        ],
